...
<ul class="mx-8! mt-10! flex list-none! flex-row flex-wrap gap-2 md:mt-12! lg:mx-10! lg:mt-14! lg:gap-3">
  {[
    'Bilboramix',
    'Demivan',
    'EltonLobo07',
...
<ul class="mx-8! mt-10! flex list-none! flex-row flex-wrap gap-x-6 gap-y-3 md:mt-12! md:gap-x-8 md:gap-y-4 lg:mx-10! lg:mt-14! lg:gap-x-10 lg:gap-y-5">
  {[
