import{a as s,s as r,t as e,q as c}from"./q-BMflDIby.js";import{u as a}from"./q--oTrDBLb.js";import"./q-DibvOihq.js";import"./q-DFFNPBxC.js";import"./q-ZqxkfwjP.js";import{P as i}from"./q-CdVP5qAT.js";const t={TInput:{modifier:"extends",type:"string"},TMessage:{modifier:"extends",type:{type:"union",options:[{type:"custom",name:"ErrorMessage",href:"../ErrorMessage/",generics:[{type:"custom",name:"IsoTimeIssue",href:"../IsoTimeIssue/",generics:[{type:"custom",name:"TInput"}]}]},"undefined"]}},BaseValidation:{modifier:"extends",type:{type:"custom",name:"BaseValidation",href:"../BaseValidation/",generics:[{type:"custom",name:"TInput"},{type:"custom",name:"TInput"},{type:"custom",name:"IsoTimeIssue",href:"../IsoTimeIssue/",generics:[{type:"custom",name:"TInput"}]}]}},type:{type:{type:"string",value:"iso_time"}},reference:{type:{type:"custom",modifier:"typeof",name:"isoTime",href:"../IsoTimeAction/"}},expects:{type:"null"},requirement:{type:{type:"custom",name:"RegExp"}},message:{type:{type:"custom",name:"TMessage"}}},y=[{text:"IsoTimeAction",id:"isotimeaction",level:1},{text:"Generics",id:"generics",level:2},{text:"Definition",id:"definition",level:2}],I={title:"IsoTimeAction",meta:[{name:"description",content:"ISO time action interface."}],styles:[],links:[],scripts:[],frontmatter:{contributors:["fabian-hiller"]}},T={title:"IsoTimeAction",description:"ISO time action interface.",contributors:["fabian-hiller"]};function d(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",span:"span",ul:"ul",...a(),...o.components};return e(c,{children:[e(n.h1,{id:"isotimeaction",children:[e(n.a,{"aria-hidden":"true",tabindex:"-1",href:"#isotimeaction",children:e(n.span,{class:"icon icon-link"})}),"IsoTimeAction"]}),`
