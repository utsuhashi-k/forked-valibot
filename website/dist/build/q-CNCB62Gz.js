...
`,n(a,{items:["check","brand","description","entries","flavor","guard","maxEntries","metadata","minEntries","notEntries","partialCheck","rawCheck","rawTransform","readonly","title","transform"]}),`
`,n(e.h3,{id:"utils",children:[n(e.a,{"aria-hidden":"true",tabindex:"-1",href:"#utils",children:n(e.span,{class:"icon icon-link"})}),"Utils"]}),`
`,n(a,{items:["entriesFromList","isOfKind","isOfType"]})]})}const w=(c={})=>{const e=i(o,{children:i(h,c,3,null)},3,"DK_k6gWc");return typeof MDXLayout=="function"?n(MDXLayout,{children:e}):e};export{w as default,v as frontmatter,x as head,j as headings};
