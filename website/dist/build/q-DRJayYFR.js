import{a as c,s as o,t as e,q as r}from"./q-BMflDIby.js";import{u as l}from"./q--oTrDBLb.js";import{a as t}from"./q-8Dh79Z6H.js";import"./q-DibvOihq.js";import"./q-DFFNPBxC.js";import"./q-ZqxkfwjP.js";import{P as s}from"./q-CdVP5qAT.js";const a={TInput:{modifier:"extends",type:"string"},TMessage:{modifier:"extends",type:{type:"union",options:[{type:"custom",name:"ErrorMessage",href:"../ErrorMessage/",generics:[{type:"custom",name:"IsoTimestampIssue",href:"../IsoTimestampIssue/",generics:[{type:"custom",name:"TInput"}]}]},"undefined"]}},message:{type:{type:"custom",name:"TMessage"}},Action:{type:{type:"custom",name:"IsoTimestampAction",href:"../IsoTimestampAction/",generics:[{type:"custom",name:"TInput"},{type:"custom",name:"TMessage"}]}}},y=[{text:"isoTimestamp",id:"isotimestamp",level:1},{text:"Generics",id:"generics",level:2},{text:"Parameters",id:"parameters",level:2},{text:"Explanation",id:"explanation",level:3},{text:"Returns",id:"returns",level:2},{text:"Examples",id:"examples",level:2},{text:"ISO timestamp schema",id:"iso-timestamp-schema",level:3},{text:"Related",id:"related",level:2},{text:"Schemas",id:"schemas",level:3},{text:"Methods",id:"methods",level:3},{text:"Utils",id:"utils",level:3}],T={title:"isoTimestamp",meta:[{name:"description",content:"Creates an ISO timestamp validation action."}],styles:[],links:[],scripts:[],frontmatter:{source:"/actions/isoTimestamp/isoTimestamp.ts",contributors:["fabian-hiller"]}},x={title:"isoTimestamp",description:"Creates an ISO timestamp validation action.",source:"/actions/isoTimestamp/isoTimestamp.ts",contributors:["fabian-hiller"]};function d(i){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l(),...i.components};return e(r,{children:[e(n.h1,{id:"isotimestamp",children:[e(n.a,{"aria-hidden":"true",tabindex:"-1",href:"#isotimestamp",children:e(n.span,{class:"icon icon-link"})}),"isoTimestamp"]}),`
...
`]}),`
`,e(n.blockquote,{children:[`
`,e(n.p,{children:[`The regex also allows a space before the UTC offset (e.g., " +00:00") to support PostgreSQL's `,e(n.code,{children:"timestamptz"})," output format."]}),`
`]}),`
...
`,e(t,{items:["isOfKind","isOfType"]})]})}const b=(i={})=>{const n=c(o,{children:c(d,i,3,null)},3,"c8qJ8HE1");return typeof MDXLayout=="function"?e(MDXLayout,{children:n}):n};export{b as default,x as frontmatter,T as head,y as headings};
