import{a as s,s as o,t as e,q as l}from"./q-BMflDIby.js";import{u as t}from"./q--oTrDBLb.js";const d=[{text:"Installation",id:"installation",level:1},{text:"General",id:"general",level:2},{text:"For AI Agents",id:"for-ai-agents",level:2},{text:"From npm",id:"from-npm",level:2},{text:"From JSR",id:"from-jsr",level:2},{text:"From Deno",id:"from-deno",level:2}],p={title:"Installation",meta:[{name:"description",content:"Valibot is currently available for Node, Bun and Deno. Below you will learn how to add the library to your project."}],styles:[],links:[],scripts:[],frontmatter:{contributors:["fabian-hiller","Shyam-Chen","jojojojojoj5564656465465","flySewa"]}},h={title:"Installation",description:"Valibot is currently available for Node, Bun and Deno. Below you will learn how to add the library to your project.",contributors:["fabian-hiller","Shyam-Chen","jojojojojoj5564656465465","flySewa"]};function i(a){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",span:"span",...t(),...a.components};return e(l,{children:[e(n.h1,{id:"installation",children:[e(n.a,{"aria-hidden":"true",tabindex:"-1",href:"#installation",children:e(n.span,{class:"icon icon-link"})}),"Installation"]}),`
...
`,e(n.p,{children:"It does not make a difference whether you use individual imports or a wildcard import. Tree shaking and code splitting should work in both cases."}),`
...
`,e(n.span,{class:"token punctuation",children:"}"}),`
`]})}),`
`,e(n.h2,{id:"for-ai-agents",children:[e(n.a,{"aria-hidden":"true",tabindex:"-1",href:"#for-ai-agents",children:e(n.span,{class:"icon icon-link"})}),"For AI Agents"]}),`
`,e(n.p,{children:"We provide an agent skill that teaches AI agents the correct patterns for generating Valibot schemas. You can install it by running the following command in your terminal:"}),`
`,e(n.pre,{class:"language-bash",children:e(n.code,{class:"language-bash",children:["npx skills ",e(n.span,{class:"token function",children:"add"}),` open-circle/agent-skills --skill valibot
`]})}),`
`,e(n.p,{children:["You can learn more about the Valibot agent skill ",e(n.a,{href:"https://github.com/open-circle/agent-skills",rel:"noreferrer",target:"_blank",children:"here"}),"."]}),`
...
`]})})]})}const u=(a={})=>{const n=s(o,{children:s(i,a,3,null)},3,"_IzLUs27");return typeof MDXLayout=="function"?e(MDXLayout,{children:n}):n};export{u as default,h as frontmatter,p as head,d as headings};
