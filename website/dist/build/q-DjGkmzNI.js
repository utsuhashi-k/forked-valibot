import{a as r,s as c,t as e,q as s}from"./q-BMflDIby.js";import{u as l}from"./q--oTrDBLb.js";import"./q-DibvOihq.js";import"./q-DFFNPBxC.js";import"./q-ZqxkfwjP.js";import{P as i}from"./q-CdVP5qAT.js";const t={TInput:{modifier:"extends",type:"string"},TMessage:{modifier:"extends",type:{type:"union",options:[{type:"custom",name:"ErrorMessage",href:"../ErrorMessage/",generics:[{type:"custom",name:"HexColorIssue",href:"../HexColorIssue/",generics:[{type:"custom",name:"TInput"}]}]},"undefined"]}},BaseValidation:{modifier:"extends",type:{type:"custom",name:"BaseValidation",href:"../BaseValidation/",generics:[{type:"custom",name:"TInput"},{type:"custom",name:"TInput"},{type:"custom",name:"HexColorIssue",href:"../HexColorIssue/",generics:[{type:"custom",name:"TInput"}]}]}},type:{type:{type:"string",value:"hex_color"}},reference:{type:{type:"custom",modifier:"typeof",name:"hexColor",href:"../hexColor/"}},expects:{type:"null"},requirement:{type:{type:"custom",name:"RegExp"}},message:{type:{type:"custom",name:"TMessage"}}},x=[{text:"HexColorAction",id:"hexcoloraction",level:1},{text:"Generics",id:"generics",level:2},{text:"Definition",id:"definition",level:2}],y={title:"HexColorAction",meta:[{name:"description",content:"Hex color action interface."}],styles:[],links:[],scripts:[],frontmatter:{contributors:["fabian-hiller"]}},g={title:"HexColorAction",description:"Hex color action interface.",contributors:["fabian-hiller"]};function a(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",span:"span",ul:"ul",...l(),...o.components};return e(s,{children:[e(n.h1,{id:"hexcoloraction",children:[e(n.a,{"aria-hidden":"true",tabindex:"-1",href:"#hexcoloraction",children:e(n.span,{class:"icon icon-link"})}),"HexColorAction"]}),`
