...
`,e(s,{items:["check","brand","description","flavor","guard","metadata","rawCheck","rawTransform","readonly","title","transform"]}),`
`,e(n.h3,{id:"utils",children:[e(n.a,{"aria-hidden":"true",tabindex:"-1",href:"#utils",children:e(n.span,{class:"icon icon-link"})}),"Utils"]}),`
`,e(s,{items:["entriesFromList","isOfKind","isOfType"]})]})}const v=(a={})=>{const n=l(c,{children:l(d,a,3,null)},3,"6VmEsJaV");return typeof MDXLayout=="function"?e(MDXLayout,{children:n}):n};export{v as default,x as frontmatter,k as head,g as headings};
